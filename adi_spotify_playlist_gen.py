...
def create_playlist(songs: list):
    client_id = 'abacd94498c945af91633a3e85ed1fa1'
    client_secret = '8f38ae574af4484c91c0e95f412c4ffe'
    # redirect_uri = 'http://localhost:8888/callback'

    username = input('Enter the link to your Spotify profile (Click on your icon on the top right, click profile, and copy paste the link here):')
...
def create_playlist_with_username(songs: list, username: str):
    client_id = 'abacd94498c945af91633a3e85ed1fa1'
    client_secret = '8f38ae574af4484c91c0e95f412c4ffe'
